...
class __TwigTemplate_06d9caca473e0088308e5c432b5f1cf1980a55d33a8acb122217ecf8eafbbe49 extends \Twig\Template
{
    private $source;
    private $macros = [];
...
";
    ...
    <p id=\"<?php echo \$view->escape(\$id); ?>_help\" <?php echo ' '.\$view['form']->block(\$form, 'attributes', ['attr' => \$help_attr]); ?>><?php echo \$help; ?></p>
<?php endif; ?>
", "FrameworkBundle:Form:form_help.html.php", "/home/vagrant/code/caldaie/vendor/symfony/framework-bundle/Resources/views/Form/form_help.html.php");
    }
}
