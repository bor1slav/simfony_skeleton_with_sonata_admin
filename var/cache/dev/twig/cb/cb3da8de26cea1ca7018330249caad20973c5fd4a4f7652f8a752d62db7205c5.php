...
class __TwigTemplate_650b46ae9e8ac51f4b888056a04f3914a9791db81d03fc34d9e9df7a0b72675e extends \Twig\Template
{
    private $source;
    private $macros = [];
...
(isset($context["field_description"]) || array_key_exists("field_description", $context) ? $context["field_description"] : (function () { throw new RuntimeError('Variable "field_description" does not exist.', 21, $this->source); })()), "associationadmin", [], "any", false, false, false, 21), "id", [0 => (isset($context["value"]) || array_key_exists("value", $context) ? $context["value"] : (function () { throw new RuntimeError('Variable "value" does not exist.', 21, $this->source); })())], "method", false, false, false, 21))) {
    ...
    {
        return array (  88 => 29,  82 => 27,  76 => 24,  71 => 23,  69 => 21,  68 => 20,  67 => 19,  66 => 18,  64 => 17,  61 => 16,  58 => 15,  51 => 14,  35 => 12,);
    }
...
{% block field %}
    ...
    {% endif %}
{% endblock %}
", "SonataAdminBundle:CRUD/Association:list_many_to_one.html.twig", "/home/vagrant/code/caldaie/vendor/sonata-project/admin-bundle/src/Resources/views/CRUD/Association/list_many_to_one.html.twig");
    }
}
